<template>
  <div class="card is-paddingless">
    <div class="box columns is-multiline">
      <div class="title">Subscribe to Spaces and Projects</div>
...
<script>
import SubscriptionButton from "../SpacesAndProjectsShared/SubscriptionButton";
      ...
      if (this.projectSpaceList[index].isSubscribed) {
        ...
        this.$axios.$delete(
                `/api/v1/profiles/${this.$store.state.user._id}/subs/${type}/${
                        this.projectSpaceList[index]._id
                }`
        );
      } else {
        this.$axios.$post(
