      ...
      <section>
        ...
        <div class="picSection">
          ...
          <a class="button action" @click="">
            <input class="file-input" type="file" ref="profilePicFile" @change="selectFile('profile')" />
        ...
        <div class="picSection">
          <p class="bannerPic">
            <img :src="editForm.headerPicture" />
          </p>
          <a class="button action" @click="">
            <input class="file-input" type="file" ref="bannerPicFile" @change="selectFile('banner')" />
            <span v-if="editForm.headerPicture">Change Banner Picture</span>
            <span v-else>Add Banner Picture</span> &nbsp; <font-awesome-icon icon="camera" />
          </a>
        </div>
