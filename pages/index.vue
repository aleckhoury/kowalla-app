    ...
    <div class="container">
      ...
      <div class="columns is-centered is-marginless is-reverse main-margin">
        <div class="column is-one-half is-full-touch is-paddingless">
          ...
          <Post v-for="post in postList" :key="post._id" :post="post" />
        </div>
        <!-- infopane -->
        <div class="column centered is-one-half is-full-touch is-paddingless">
          <div class="description-width">
            <DescriptionCard
              :subheader-on="false"
              header-string="About Kowalla"
            >
              <p>
                Welcome to Kowalla. We're building the world's first fully
                online coworking space. We want to bring you the community of a
                coworking space, without the desk.
              </p>
              <br >
              <p>
                Our team at Kowalla is building a platform to take the best
                elements of top tech communities across the world and bring them
                online. Our platform will be a place to create, collaborate and
                share your projects in the open. We believe that in a truly
                connected world, everyone should be able to be a part of the
                communities they're passionate about, no matter where they're
                from. Talent, ambition, ideas and execution should be the only
                limit to your success and not geography.
              </p>
            </DescriptionCard>
          </div>
